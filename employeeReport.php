...
<html lang="en">
    <head>
        <?php
            ...
            $sql = "SELECT employee.EmpName, employee.EmpLname, service.SerName, service_bill.SerDate, service.Price
                    FROM employee, service_bill, service
                    WHERE employee.EmpID = service_bill.EmpID
                    AND service_bill.SerID = service.SerID
                    AND service_bill.EmpID = ".$_GET['empid'];
            $result = mysqli_query($connect,$sql);
            $row = mysqli_fetch_array($result);
        ?>
        <title><?php echo $row['EmpName'] ." ". $row['EmpLname'] ?></title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <h3 class="col-6"><?php echo $row['EmpName'] ." ". $row['EmpLname']?></h3> 
                <div class="col-6">
                    <div class="form-group float-right">
                    <input type="hidden" id="reportName" value="emp">
            ...
            <div id="reportTable">
                <h3 id="tittle"><?php echo $row['EmpName'] ." ". $row['EmpLname'] ." Report"; ?></h3> 
                <?php 
                    include("pdfFromHTML.php"); 
                    include("printContent.php"); 
                ?>
