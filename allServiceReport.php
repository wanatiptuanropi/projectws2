...
<html lang="en">
    <head>
        <title>All Services Report</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <h3 class="col-6">All Service Report</h3> 
                <div class="col-6">
                    <div class="form-group float-right">
                        <input type="hidden" id="reportName" value="allSer">
            ...
            <div id="reportTable">
            <h3 id="tittle">All Service Report</h3> 
            <?php
                $totalPrice = 0;
                for($i = 0; $i < $numrows; $i++)
                {            
                    $sql = "SELECT employee.EmpName, employee.EmpLname, service_bill.SerDate, service.SerName, service.Price, pet.PetName
                            ...
                            AND service_bill.SerID = ".$service[$i];
                    $result = mysqli_query($connect,$sql);
                    $row = mysqli_fetch_array($result);
                ?>

                    <h3><?php echo $row['SerName'] ?></h3>
